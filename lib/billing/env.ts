...
export const STRIPE_CUSTOMER_PORTAL_CONFIGURATION_ID_ENV =
...
export const STRIPE_GROUP_MONTHLY_PRICE_ID_ENV =
  "STRIPE_GROUP_MONTHLY_PRICE_ID";
export const STRIPE_GROUP_YEARLY_PRICE_ID_ENV = "STRIPE_GROUP_YEARLY_PRICE_ID";
export const STRIPE_GROUP_ADDITIONAL_SITE_MONTHLY_PRICE_ID_ENV =
  "STRIPE_GROUP_ADDITIONAL_SITE_MONTHLY_PRICE_ID";
export const STRIPE_GROUP_ADDITIONAL_SITE_YEARLY_PRICE_ID_ENV =
...
export const STRIPE_PRICE_ENV_KEYS = {
  ...
  GROUP_MONTHLY: STRIPE_GROUP_MONTHLY_PRICE_ID_ENV,
  GROUP_YEARLY: STRIPE_GROUP_YEARLY_PRICE_ID_ENV,
  GROUP_ADDITIONAL_SITE_MONTHLY:
    STRIPE_GROUP_ADDITIONAL_SITE_MONTHLY_PRICE_ID_ENV,
  GROUP_ADDITIONAL_SITE_YEARLY:
