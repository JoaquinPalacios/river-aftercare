...
Public published prices (AUD): Essential A$79/month or A$790/year, Practice A$149/month or A$1,490/year, Group custom pricing. Do not claim GST is included or excluded. River Aftercare is not registering for GST at this stage. The product can manage multiple sites and locations. Group base is A$449/month or A$4,490/year for 2 Clinic Sites and 5 Locations, and each Additional Site bundle is A$50/month or A$500/year for one more site and one more location. Do not publish those Group rates; public copy stays custom and directs multi-location practices to talk to us. Group Checkout is not implemented. Annual billing is 12 months for the price of 10. Check-ins remain unpriced post-launch work and are not advertised on the public pricing page. Contact delivery is a server-side clinic enquiry form (`CONTACT_EMAIL_TO` / Resend / Turnstile). See [MARKETING-CONTACT.md](../architecture/MARKETING-CONTACT.md).
