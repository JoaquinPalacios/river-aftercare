...
| Term              | Meaning                                                                                                                                                                                                                   |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Practice / Clinic | Product language for the paying customer. Stored as Prisma `Clinic`.                                                                                                                                                      |
| Tenant            | Architectural term for the public hostname. That hostname is `ClinicSite.slug`. `Clinic.slug` remains compatibility data.                                                                                                 |
| Account           | `Clinic` is the paying customer. The Prisma model name stays `Clinic`.                                                                                                                                                    |
| Clinic site       | `ClinicSite` is the public identity: subdomain and branding. The current product has one primary site per account. Creating more sites is not enabled.                                                                    |
| Location          | `ClinicLocation` is a physical practice belonging to a clinic site. The current product reads one root location. Patient URLs, portal, and QR still behave as one location. Site and location management are not enabled. |
...
| OD-13 | Multi-location within one customer                                    | The product can manage Clinic Sites and Locations. Essential is 1 site and 1 location. Practice is 1 site and an operator-set location allowance. An active configured Group account derives capacity: 2 sites and 5 locations, plus one site and one location per purchased Additional Site, plus complimentary extras. Group base is A$449/month or A$4,490/year. Each Additional Site bundle is A$50/month or A$500/year. Annual billing is 12 months for the price of 10. Public Group pricing stays custom. `ClinicProfile` and `Clinic.slug` remain compatibility fields. |
