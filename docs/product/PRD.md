...
| OD-13 | Multi-location within one customer                                    | The product can manage Clinic Sites and Locations. Essential is 1 site and 1 location. Practice is 1 site and an operator-set location allowance. Group site and location totals are operator-set. Approved direction, not yet in Stripe: A$449/month base is 2 sites and 5 locations, and a +A$50/month site bundle adds one site and one location. Annual Group pricing is not decided. `ClinicProfile` and `Clinic.slug` remain compatibility fields. |
