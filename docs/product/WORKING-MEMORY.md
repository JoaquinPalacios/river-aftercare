...
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Essential | 1 practice / location; River Aftercare guide templates; **Create and edit up to 2 custom clinic guides**; **Edit up to 2 River Aftercare templates**; up to 2 team members; branded pages; logo/colours/typography*; QR / PDF / durable URLs |
| Practice  | Everything in Essential; **Up to 30 custom clinic guides**; **Edit up to 10 River Aftercare templates**; up to 5 team members; Assisted setup. Supporting callout remains “Multi-location practice? Talk to us about your setup.”            |
| Group     | Unchanged. Custom pricing. Coordinated rollout / custom onboarding / priority support / tailored account setup.                                                                                                                              |

Commercial distinction: original custom guides and editable River-template copies are independent pools. Essential base is 2 team members, 2 original custom guides, and 2 editable template copies. Practice base is 5, 30, and 10. Using a River template as supplied consumes neither pool. Editing it forks a clinic-owned copy and consumes one editable-template place. Phase 4 enforces those allowances, plus persistent operator extras that do not change Stripe. Group has no fixed cap. A clinic with no entitlement row stays legacy-open.
...
| Limits       | Phase 4 enforces Essential 2 and Practice 5 inside `reserveTeamPlace` on invite and reactivation. Pending invitations reserve one place. UI says “team members used”. A clinic administrator at the cap is blocked. A platform operator must explicitly override that one operation. The posted flag is ignored unless the session role is OPERATOR. Group and clinics with no entitlement stay open. Inviting does not change Stripe. |
