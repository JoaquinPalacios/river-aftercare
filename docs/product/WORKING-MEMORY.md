...
Last updated: 2026-09-25 (production Functions verified in `syd1` after PR #102; patient TTFB remeasured; next code change is the staff client bundle, not patient SQL)
