...
- Team usage above the effective Essential team allowance still blocks scheduling. Guide overage does not, once the clinic ADMIN has confirmed a keep-set that fits Essential. The operator prepares that selection locally and does not choose the guides. STAFF cannot confirm it.
