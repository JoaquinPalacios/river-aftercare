...
| Production prices | Public: Essential **A$79/month or A$790/year**, Practice **A$149/month or A$1,490/year** (Recommended), Group **Custom pricing**. All public prices GST-inclusive AUD. Additional-location **rates are internal only** (2nd A$79/A$790, 3rd+ A$59/A$590) until a Location model exists — public copy is “talk to us about your setup”; do not advertise a larger guide library. Canonical source: `lib/marketing/plans.ts`. Essential includes **create and edit up to 2 custom clinic guides** (normal editor; not a crippled editor). Practice public bullets are **Everything in Essential**, **up to 30 custom clinic guides**, **adapt River Aftercare templates to suit your clinic**, and **Assisted setup**. Essential may use River templates as supplied; Practice may adapt them into clinic-owned custom guides (future adapted-template counts toward the custom-guide allowance). Guide counts and template-adaptation entitlement are commercial copy, not technically enforced. Do not advertise editor controls, clinic-specific instructions, or numeric location pricing as Practice-only. Essential typography feature uses a discreet `*` footnote: six curated typefaces, additional options on request — do not list font names on `/pricing`. |
...
| SEO               | Launch policy in [SEO.md](../architecture/SEO.md): marketing indexable; staff/operator/preview `noindex, nofollow`; tenant patient pages `noindex, follow` by default; sitemap is marketing-only. Optional `CARE_GUIDE_METADATA_BASE`. SoftwareApplication JSON-LD; `/pricing` only adds GST-inclusive Essential/Practice Offers.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| JSON-LD          | Server-generated Organization / WebSite / SoftwareApplication / ContactPage / AboutPage. `/pricing` attaches GST-inclusive Essential and Practice Offers in AUD. Group is not a numeric offer.                                                                                                                                                                                                                                                                                             |
