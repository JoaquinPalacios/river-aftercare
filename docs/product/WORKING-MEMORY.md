...
Last updated: 2026-09-19 (Production pricing truth pass: no public location rates; no “active” guide wording)
...
| Production prices | Public: Essential **A$79/month or A$790/year**, Practice **A$149/month or A$1,490/year** (Recommended), Group **Custom pricing**. All public prices GST-inclusive AUD. Additional-location **rates are internal only** (2nd A$79/A$790, 3rd+ A$59/A$590) until a Location model exists — public copy is “talk to us about your setup”. Canonical source: `lib/marketing/plans.ts`. Essential 2 / Practice 30 custom guides are commercial copy, not an archive/active entitlement. |
