...
Last updated: 2026-09-25 (production marketing static delivery verified on `97ce087`; homepage median TTFB 84.8ms and pricing 55.0ms from a US runner; patient and staff hosts stay `no-store`; next performance change is Sentry browser-SDK loading, not patient SQL)
