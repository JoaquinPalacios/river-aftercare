...
Last updated: 2026-09-19 (Production pricing and plan positioning; curated clinic typefaces)
...
| Production prices | Essential **A$79/month or A$790/year**, Practice **A$149/month or A$1,490/year** (Recommended), Group **Custom pricing**. All public prices GST-inclusive AUD. Practice additional locations: 2nd A$79/A$790, 3rd+ A$59/A$590 each. No public Group floor. Canonical source: `lib/marketing/plans.ts`. Essential 2 / Practice 30 active custom guides and extra locations are **commercial copy** until plan/location entitlements exist. |
