...
| Dark            | Illumination/glow rather than filled colour. Dental periwinkle bloom, physio strongest sky mist, chiro cobalt depth (`#2c46c4` / `#3d58d6`), cosmetic softer lavender.                                                                                                                                                                    |
