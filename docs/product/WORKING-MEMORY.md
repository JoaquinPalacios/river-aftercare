...
| Motion       | 120ms show delay, ~10%→35%→62%→82% while waiting, 200ms minimum visible, 140ms snap to 100%, 150ms fade. Fast navigations never flash. 15s stuck navigations hide without claiming 100%.                                                                                                                                                                                                                                                                                                |
...
| Patient CSS  | Tenant pages do not load `navigationProgress`. Local Playwright still reports tenant CSS raw ~67,658 vs the 26,000 budget because the patient chunk includes the full clinic typeface catalog `@font-face` (Inter/Roboto/Poppins/Montserrat/Open Sans/Lato), not this overlay.                                                                                                                                                                                                          |
