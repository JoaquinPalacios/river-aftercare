...
Capacity is enforced. Essential is 1 site and 1 location. Practice is 1 site and the stored location allowance. An ACTIVE Group entitlement whose purchased Additional Site quantity is recorded uses `2 + N + extra sites` and `5 + N + extra locations`. Until that quantity is recorded, stored Group totals stay in force. A pending Group offer does not receive 2/5. A missing entitlement is 1 site and 1 location, never unlimited. Group base is A$449/month or A$4,490/year and includes 2 sites and 5 locations. Each Additional Site bundle is A$50/month or A$500/year and adds one site and one location. Annual billing is 12 months for the price of 10. Public marketing stays Custom pricing. New operator clinics and the demo seed write the account, primary site, and root location together.
