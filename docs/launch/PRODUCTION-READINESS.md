...
| Production migrations        | REQUIRED BEFORE PRODUCTION | Local chain is PostgreSQL 18 compatible. Additive `AccountToken` migration `20260919120000_add_account_token` is already applied in production. This password-management change adds **no** new Prisma migration.                                                                                                                                                                                            |
